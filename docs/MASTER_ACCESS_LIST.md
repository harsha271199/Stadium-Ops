...
| **Premium Employee** | Shared code `70000` + last name, or last-5 ID + 4-digit PIN | Sees only their own assigned Premium location(s) and who else covers them. No concession/warehouse/NPO data at all. |
| **Premium Manager** | Shared code `70000` + last name — every Premium Manager uses this, no exceptions: Hernandez, Nestor / Crnjac, Natasha / Larson, Amy / Pouessel, Emma | Creates Premium location names, assigns Premium Employees/Managers to locations, sees the full Premium roster and today's check-ins (present/absent/move/walk-in) across every Premium location. Still no visibility into concession, warehouse, food or NPO data — Premium is a fully separate department, same as Warehouse. |
